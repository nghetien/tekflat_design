...
class TekDataTableReorderablePaginationWidget<T> extends StatefulWidget {
  const TekDataTableReorderablePaginationWidget({
    Key? key,
  ...
  @override
  State<TekDataTableReorderablePaginationWidget> createState() => _TekDataTableReorderablePaginationWidgetState();
}

class _TekDataTableReorderablePaginationWidgetState extends State<TekDataTableReorderablePaginationWidget> {
  TekDataTableReorderablePagination get pagination => widget.controller.pagination;
  ...
  void _handleChangeDataPageNumber(int pageNumber) {
    ...
    if (widget.controller.additionColumns.contains(TekDataTableReorderableAdditionColumn.checkbox)) {
